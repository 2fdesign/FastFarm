...
- (void)refreshTable
{
   ...
   [_http1 getWaterDataForUser:[user getUserName] password:[user getPassword]];
}
...
-(void) httpNewData:(NSMutableArray *)data
{
   ...
   UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"No water sites found" message:@"There are no water usage sites currently loaded against this user" delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
   [alert show];
}
